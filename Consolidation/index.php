...
<div class="wrap">
  <div class="cardX">
    ...
    <div>
      <a class="rpt-link" href="/Consolidation/Reports/report_balance_sheet_home.v7.php">
        <div class="rpt-title"><i class="fa fa-scale-balanced me-2 text-primary"></i>Balance Sheet — Branch Wise</div>
        <div class="rpt-desc">Branch balance sheet for a single month-end date (Assets &amp; Liabilities)</div>
      </a>
